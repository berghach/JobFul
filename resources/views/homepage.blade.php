...
<x-layout title="Homepage">
    ...
    {{-- Recent posts --}}
    <section class=" flex flex-wrap gap-3 justify-center w-full pt-3">
        <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100">
            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={{ Vite::asset('resources/images/website-id.png')}} alt="">
