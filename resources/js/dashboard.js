function addLink() {
    ...
    linkDiv.innerHTML = `
        <input id="links[${linkCount}][url]" type="text" name="links[${linkCount}][url]" class="block mt-1 w-full h-10 ps-3 border-gray-300 border-2 rounded-xl shadow-sm"  placeholder="Link ${linkCount + 1}"/>
